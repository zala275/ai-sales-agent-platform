    ...
    if (pathname.startsWith("/api/")) {
        ...
        if (pathname === "/api/chat" && req.method === "POST") {
            ...
            if (message.includes("chatbot") || message.includes("bot") || message.includes("not a bot") || message.includes("who are you")) {
                ...
                reply = "SalesAI is currently 100% Free with zero payment required! You get full access to autonomous sales capabilities, CRM sync, and lead capture. Future commercial roadmap tiers will range from $29 to $199/mo, but right now you can deploy freely. What is your business email to get started?";
